...
\usepackage[
	...
	pdfauthor = {grutp1},        					  % PDF-property
	pdfsubject = {Mini-Projekt},        % PDF-property
...
\setcounter{page}{1}
\phantomsection 
\addcontentsline{toc}{chapter}{Zusammnefassung}
...
\include{kapitel/swot}
\include{kapitel/rosette}
\include{kapitel/systemgrenze}
\include{kapitel/energiebilanz}
...
\appendix
\settocdepth{section}
\include{anhang/reflexion}
\include{anhang/projektskizeanhang}
%---------------------------------------------------------------------------
